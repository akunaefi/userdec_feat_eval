...
# df_free.to_csv('../data/free_app_reviews_filtered.csv')
# df_paid.to_csv('../data/paid_app_reviews_filtered.csv')


df_free = pd.read_csv('../data/free_app_reviews_filtered.csv')
df_paid = pd.read_csv('../data/paid_app_reviews_filtered.csv')
