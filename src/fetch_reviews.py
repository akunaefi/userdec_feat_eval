...
class PlayReviews:
    ...
    def fetch_reviews(self, app_id, page_num, sort_by):
        ...
        payload = {'reviewType': '0', 'pageNum': page_num, 'id': app_id, 'xhr': '1', 'reviewSortOrder': sort_by, 'hl':'en_US'}
...
if __name__ == '__main__':
    # app_id = 'com.payoneer.android' #business & finance
    # app_id = 'com.payeer' # business & finance
    # app_id = 'com.wunderground.android.weather' # weather
    # app_id = 'com.fitbit.FitbitMobile' # health & fitness
    # app_id = 'com.antiy.avlpro' # security & antivirus
    # app_id = 'com.wsandroid.suite' # security & antivirus
    # app_id = 'no.mobitroll.kahoot.android' # education
    # app_id = 'com.smule.singandroid' #music & audio
    # app_id = 'com.gopro.smarty' # video
    # app_id = 'com.adobe.adobephotoshopfix' #photograpy
    # app_id = 'com.bloomberg.android.plus' # news & magazine
    # app_id = 'com.joelapenna.foursquared' # food & drinks
    # app_id = 'wp.wattpad' # books & reference
    # app_id = 'com.nintendo.zara' # games
